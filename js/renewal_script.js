...
$(function() {
    ...
    var $nav = $('.subNav .navGroup');
    var $gnb = $('.subNav .navGroup .gnb');
    var $lnb = $('.subNav .navGroup .lnb');
    ...
    //     $('#filter-new, #filter-recommend, #filter-popular, #filter-book, #filter-sale').change(function(){
    //         if($(this).is(':checked')){
    //             console.log('check!');
    //         }else{
    //             console.log('uncheck!');
